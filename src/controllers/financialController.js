...
/**
 * Controller para gerenciar operações financeiras
 */
console.log('financialController.js carregado');
class FinancialController {
  /**
   * @function getSaldo
   * @description Obtém o saldo atual.
   * @param {Object} req - Objeto de requisição Express
   * @param {Object} res - Objeto de resposta Express
   * @returns {Object} Resposta JSON com o saldo atual formatado.
   * @throws {Error} Erro ao obter o saldo.
   */
   ...
   /**
    * @function getValorGastoPorData
    * @description Obtém o valor gasto por data.
    * @param {Object} req - Objeto de requisição Express
    * @param {Object} res - Objeto de resposta Express
    * @returns {Object} Resposta JSON com o valor gasto por data formatado.
    * @throws {Error} Erro ao obter o valor gasto por data.
   */
    ...
    /**
     * @function getSaldoPorDia
     * @description Obtém o saldo por dia.
     * @param {Object} req - Objeto de requisição Express
     * @param {Object} res - Objeto de resposta Express
     * @returns {Object} Resposta JSON com o saldo por dia formatado.
     * @throws {Error} Erro ao obter o saldo por dia.
     */
   ...
   /**
    * @function getValorPorCategoria
    * @description Obtém o valor gasto por categoria.
    * @param {Object} req - Objeto de requisição Express
    * @param {Object} res - Objeto de resposta Express
    * @returns {Object} Resposta JSON com o valor gasto por categoria formatado.
    * @throws {Error} Erro ao obter o valor gasto por categoria.
    */
     ...
     * @description Filtra as transações com base em categorias e datas.
     * @param {Object} req - Objeto de requisição Express
     * @param {Object} res - Objeto de resposta Express
     * @returns {Object} Resposta JSON com as transações filtradas formatadas.
     * @throws {Error} Erro ao filtrar as transações.
     */
     ...
     * @description Obtém o resumo financeiro.
     * @param {Object} req - Objeto de requisição Express
     * @param {Object} res - Objeto de resposta Express
     * @returns {Object} Resposta JSON com o resumo financeiro formatado.
     * @throws {Error} Erro ao obter o resumo financeiro.
     */
 ...
 * @description Obtém todas as categorias disponíveis.
 * @param {Object} req - Objeto de requisição Express
 * @param {Object} res - Objeto de resposta Express
 * @returns {Object} Resposta JSON com as categorias.
 * @throws {Error} Erro ao obter as categorias.
 */
